...
-- Create enums
DO $$ BEGIN
  CREATE TYPE "UserRole" AS ENUM ('MENTEE', 'MENTOR', 'HR_ADMIN');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "LeadershipStyle" AS ENUM ('DIRECT', 'COLLABORATIVE', 'ANALYTICAL', 'SUPPORTIVE', 'VISIONARY');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "PreferredMeetingFormat" AS ENUM ('IN_PERSON', 'VIRTUAL', 'HYBRID');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
  CREATE TYPE "SessionStatus" AS ENUM ('PENDING', 'ACCEPTED', 'DECLINED', 'COMPLETED', 'CANCELLED', 'RESCHEDULED');
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
CREATE TABLE IF NOT EXISTS "Mentee" (
  ...
  "employmentDate" TEXT,
  "competencyGaps" TEXT[] DEFAULT ARRAY[]::TEXT[],
  "careerGoals" TEXT NOT NULL,
  "personalInterests" TEXT[] DEFAULT ARRAY[]::TEXT[],
  "preferredMeetingFormat" "PreferredMeetingFormat" NOT NULL,
  "organizationalChallenge" TEXT,
  "softSkillsGap" TEXT[] DEFAULT ARRAY[]::TEXT[],
  "gradeLevel" INTEGER,
...
CREATE TABLE IF NOT EXISTS "Mentor" (
  ...
  "leadershipStyle" "LeadershipStyle" NOT NULL,
  "coachingGoals" TEXT,
  "personalInterests" TEXT[] DEFAULT ARRAY[]::TEXT[],
  "shadowSkills" TEXT[] DEFAULT ARRAY[]::TEXT[],
  "commitmentAvailability" TEXT,
...
-- MenteePreference table
CREATE TABLE IF NOT EXISTS "MenteePreference" (
  "id" TEXT NOT NULL DEFAULT gen_random_uuid()::text,
  ...
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "MenteePreference_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "MenteePreference_menteeId_fkey" FOREIGN KEY ("menteeId") REFERENCES "Mentee"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "MenteePreference_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "Mentor"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- MentorMenteeAssignment table
CREATE TABLE IF NOT EXISTS "MentorMenteeAssignment" (
  "id" TEXT NOT NULL DEFAULT gen_random_uuid()::text,
  "menteeId" TEXT NOT NULL,
  "mentorId" TEXT NOT NULL,
  "assignedByHrEmail" TEXT NOT NULL,
  "assignmentReason" TEXT,
  "isOverride" BOOLEAN NOT NULL DEFAULT false,
  "originalSystemRank" INTEGER,
  "status" TEXT NOT NULL DEFAULT 'CONFIRMED',
  "menteeAccepted" BOOLEAN NOT NULL DEFAULT false,
  "mentorAccepted" BOOLEAN NOT NULL DEFAULT false,
  "confirmedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "MentorMenteeAssignment_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "MentorMenteeAssignment_menteeId_fkey" FOREIGN KEY ("menteeId") REFERENCES "Mentee"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "MentorMenteeAssignment_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "Mentor"("id") ON DELETE NO ACTION ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "MatchingScore" (
  ...
  "menteeId" TEXT NOT NULL,
  "mentorId" TEXT NOT NULL,
  "competencyAlignmentScore" DOUBLE PRECISION NOT NULL,
  "experienceGapScore" DOUBLE PRECISION NOT NULL,
  "crossFunctionalScore" DOUBLE PRECISION NOT NULL,
  "careerAspirationScore" DOUBLE PRECISION NOT NULL,
  "leadershipStyleScore" DOUBLE PRECISION NOT NULL,
  "personalInterestsScore" DOUBLE PRECISION NOT NULL,
  "wildcardAlignmentScore" DOUBLE PRECISION NOT NULL,
  "availabilityFormatScore" DOUBLE PRECISION NOT NULL,
  "preferenceScore" DOUBLE PRECISION NOT NULL,
  "totalScore" DOUBLE PRECISION NOT NULL,
  "calculatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "MatchingScore_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "MatchingScore_menteeId_fkey" FOREIGN KEY ("menteeId") REFERENCES "Mentee"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "MatchingScore_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "Mentor"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "AuditLog" (
  ...
  CONSTRAINT "AuditLog_menteeId_fkey" FOREIGN KEY ("menteeId") REFERENCES "Mentee"("id") ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT "AuditLog_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "Mentor"("id") ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT "AuditLog_assignmentId_fkey" FOREIGN KEY ("assignmentId") REFERENCES "MentorMenteeAssignment"("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "MentoringSession" (
  ...
  "meetingFormat" "PreferredMeetingFormat" NOT NULL DEFAULT 'VIRTUAL',
  "meetingLink" TEXT,
  "location" TEXT,
  ...
  CONSTRAINT "MentoringSession_menteeId_fkey" FOREIGN KEY ("menteeId") REFERENCES "Mentee"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "MentoringSession_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "Mentor"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
export async function GET(request: Request) {
  ...
  try {
    // Use Prisma to execute raw SQL - this works in serverless!
    ...
    for (const stmt of statements) {
      try {
        ...
        if (!e.message?.includes('already exists') && !e.message?.includes('duplicate')) {
          results.push('Warning: ' + e.message?.substring(0, 100));
        }
      }
    }
